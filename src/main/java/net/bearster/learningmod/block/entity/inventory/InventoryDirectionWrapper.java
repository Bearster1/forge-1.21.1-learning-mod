package net.bearster.learningmod.block.entity.inventory;
    ...
    public InventoryDirectionWrapper(IItemHandlerModifiable handler, InventoryDirectionEntry... entries) {
        ...
        for (var x : entries) {
            directionsMap.put(x.direction,
                    LazyOptional.of(() -> new WrappedHandler(handler, (i) -> Objects.equals(i, x.slotIndex), (i, s) -> x.canInsert && i == x.slotIndex)));
        }
    }
}
