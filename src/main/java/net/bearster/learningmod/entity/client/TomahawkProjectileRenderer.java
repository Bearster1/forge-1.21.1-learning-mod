...
import net.bearster.learningmod.entity.custom.TomahawkProjectileEntity;
...
public class TomahawkProjectileRenderer extends EntityRenderer<TomahawkProjectileEntity> {
    ...
    public TomahawkProjectileRenderer(EntityRendererProvider.Context pContext) {
        super(pContext);
        model = new TomahawkProjectileModel(pContext.bakeLayer(ModModelLayers.TOMAHAWK));
    }
    ...
    public ResourceLocation getTextureLocation(TomahawkProjectileEntity entity) {
        return ResourceLocation.fromNamespaceAndPath(LearningMod.MOD_ID, "textures/entity/tomahawk/tomahawk.png");
    }
}
