...
import net.bearster.learningmod.worldgen.ModPlacedFeatures;
...
public class ModOverworldBiomes {
    ...
    public static Biome kaupenValley(HolderGetter<PlacedFeature> placedFeatureGetter, HolderGetter<ConfiguredWorldCarver<?>> carverGetter) {
        ...
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, ModPlacedFeatures.CATMINT_PLACED_KEY);
