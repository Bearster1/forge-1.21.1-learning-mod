package net.bearster.learningmod.worldgen.biome;

import net.bearster.learningmod.LearningMod;
import net.bearster.learningmod.worldgen.biome.region.NetherRegion;
import net.bearster.learningmod.worldgen.biome.region.OverworldRegion;
...
public class ModBiomes {
    ...
    public static void registerBiomes() {
        Regions.register(new OverworldRegion(ResourceLocation.fromNamespaceAndPath(LearningMod.MOD_ID, "learningmod_overworld"), 20));
        Regions.register(new NetherRegion(ResourceLocation.fromNamespaceAndPath(LearningMod.MOD_ID, "learningmod_nether"), 20));
    ...
    private static ResourceKey<Biome> registerBiomeKey(String name) {
        return ResourceKey.create(Registries.BIOME, ResourceLocation.fromNamespaceAndPath(LearningMod.MOD_ID, name));
    }
}
